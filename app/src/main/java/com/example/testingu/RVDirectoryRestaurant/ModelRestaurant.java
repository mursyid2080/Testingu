...
public class ModelRestaurant {
    ...
    public ModelRestaurant(String id, String restaurantName, String address, String image,
                           String latitude, String longitude, String kk, String category, String restaurantOpen) {
        this.id = id;
